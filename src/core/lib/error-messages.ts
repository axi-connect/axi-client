...
const MESSAGES_BY_CODE: Record<string, string> = {
  ...
  "identities/branch_not_found": "La sucursal ya no existe",
  "identities/branch_name_taken": "Ya existe una sucursal con ese nombre",
  "payments/method_not_found": "El medio de pago ya no existe",
  "payments/label_taken": "Ya existe un medio de pago con ese nombre",
  "geo/rate_limited": "El buscador de direcciones está ocupado. Intenta en unos segundos",
  ...
  // Tareas de agente. Todos dicen qué hacer, no solo qué pasó.
  "crm/agent_task_wrong_endpoint": "Esa tarea la ejecuta un agente: créala desde «Un agente de IA»",
  "crm/agent_not_found": "El agente ya no existe",
  "crm/agent_not_active": "Ese agente está pausado: actívalo para que pueda ejecutar tareas",
  "crm/agent_tasks_disabled": "Las tareas de agente están desactivadas en esta empresa",
  "crm/task_objective_required": "Cuéntale al agente qué quieres lograr, con un poco más de detalle",
  "crm/task_not_agent_task": "Esa tarea la hace una persona, no un agente",
