...
// Vivía en `modules/scheduling/domain/`; promovido a core en F3 del método comercial porque `commercial` usa la
// misma aritmética de días (DayKey a mediodía UTC) y core no depende de ningún slice.
