...
const navItems: NavItem[] = [
    ...
    { 
        ...
        hasDropdown: true,
        dropdownItems: [
            { name: 'CRM + IA', href: '/blog', description: 'Administra tus interacciones con clientes' },
            { name: 'Gestor de Riesgos', href: '/casos', description: 'Identifica, analiza y responde a amenazas' },
            { name: 'Leads Calificados', href: '/ayuda', description: 'Compra listas de leads calificados' },
        ],
    },
    { 
        name: 'Soluciones', 
        ...
        hasDropdown: true,
        dropdownItems: [
            { name: 'Califica Leads', href: '/blog', description: 'Ideas y actualizaciones' },
            { name: 'Cierra Ventas', href: '/casos', description: 'Resultados reales' },
            { name: 'Retiene Clientes', href: '/ayuda', description: 'Guías y soporte' },
            { name: 'Programa Reuniones', href: '/ayuda', description: 'Guías y soporte' },
        ],
    },
