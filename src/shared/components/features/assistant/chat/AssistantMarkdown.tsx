...
import {
  ...
  type ListItem,
  type Span,
} from "@/shared/components/features/assistant/chat/markdown";
...
export function AssistantMarkdown({
  ...
  return (
    <div className={cn("text-[15px] leading-[1.55]", className)}>
...
function BlockNode({
  ...
  if (block.kind === "heading") {
    return (
      <p
        className={cn(
          "font-heading text-[16px] leading-snug font-bold text-foreground",
