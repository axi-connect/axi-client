...
const QUESTION: AssistantQuestionData = {
...
function view(over: Partial<Parameters<typeof AssistantQuestion>[0]> = {}) {
...
describe("la pregunta con opciones de Axel", () => {
  ...
  it("cada asistente pone sus textos: eyebrow y salida por props", () => {
    const { onWriteInstead } = view({
      labels: { live: "Elige una", answered: "Ya respondida", writeInstead: "Prefiero contarlo yo" },
    });
