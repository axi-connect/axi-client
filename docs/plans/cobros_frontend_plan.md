...
| F3 UI · certificada | `audit-agent` certificó F3 al completo el 2026-09-17 (cliente `ce9a092`, servidor `2857a1f2`), revirtiendo con sus manos dos arreglos para ver caer sus tests. **Abierto para F9:** `reported_amount_cents` se guarda pero el timeline no lo pinta — ni siquiera muestra cuánto se verificó, que en pagos parciales es la mitad del hecho. **Decisión del dueño (D15):** el rail y el diálogo se quedan SIN gatear por función, iguales para todos los tenants; lo gateado es lo que de verdad es una función (cuotas, cartera, TRM, exigir el importe). **No desplegada**: el dueño decidió esperar. |
