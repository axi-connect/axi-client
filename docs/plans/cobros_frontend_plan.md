...
| F4–F9 | Pendientes (cada una arranca con su mockup). **F4 arranca con D14**: un pedido se puede entregar con saldo pendiente, así que la Cartera tiene que distinguir al que YA VIAJÓ y debe —su caso más urgente— del que aún no ha salido. |
