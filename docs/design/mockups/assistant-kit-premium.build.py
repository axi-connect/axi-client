#!/usr/bin/env python3
"""Mockup F0 · kit compartido de asistente premium (Axel /cmo y Alba /configurar).

Genera `assistant-kit-premium.html` junto a este script. Tokens literales de
...
data URI y Poppins de Google Fonts (el CSP del Artifact solo admite ese host).
    ...
    python3 docs/design/mockups/assistant-kit-premium.build.py
"""
